...
router.get('/', function(req, res, next) {
  ...
  var sql ='SELECT p.abreviatura, cd."periodo", cd."porcentaje","sim_Rango_MA","num_Rango_MA","sim_Rango_A","num_Rango_A","sim_Rango_I","num_Rango_I" FROM "Datawarehouse"."KPI_Desercion_Cohorte" cd JOIN public.programas p ON p.snies=cd."programa" join manuales_indicadores on manual=manuales_indicadores.codigo WHERE cd."programa" '+"= '1206'"+ ' ORDER BY cd."periodo" DESC LIMIT 5';
...
router.post('/', function(req, res, next) {
  ...
  var sql ='SELECT p.abreviatura, cd."periodo", cd."porcentaje","sim_Rango_MA","num_Rango_MA","sim_Rango_A","num_Rango_A","sim_Rango_I","num_Rango_I" FROM "Datawarehouse"."KPI_Desercion_Cohorte" cd JOIN public.programas p ON p.snies=cd."programa" join manuales_indicadores on manual=manuales_indicadores.codigo WHERE ';
  //aqui se crea la conexion a DB
