    ...
    client.query(sql,[req.body.user], function(err, result) {
      ...
      if(result.rowCount>0){
        ...
        let mailOptions = {
            ...
            text: 'http://localhost:3000/recover/'+result.rows[0].encriptado+'/'+fec, // plain text body
            text: 'http://localhost:3000/recover?clave='+result.rows[0].encriptado+'&fe='+fec, // plain text body
        };
