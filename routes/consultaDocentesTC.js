...
router.get('/', function(req, res, next) {
  if(req.query.c == 1)
    ...
    var sql ='SELECT spctt."Anho",spctt.razonanual,spctt.razonb,spctt.estudiantes,spctt.docentestc,spctt.docentesoc,"sim_Rango_MA","num_Rango_MA","sim_Rango_A","num_Rango_A","sim_Rango_I","num_Rango_I" FROM "Datawarehouse"."KPI_Estudiantes_por_Docentes_TC" spctt join manuales_indicadores on "manual_Estu_Docente"=codigo WHERE spctt.departamento='+"'UD'"+' GROUP BY spctt."Anho",spctt.razonanual,spctt.razonb,spctt.estudiantes,spctt.docentestc,spctt.docentesoc,"sim_Rango_MA","num_Rango_MA","sim_Rango_A","num_Rango_A","sim_Rango_I","num_Rango_I" ORDER BY spctt."Anho"';
...
/*  else if (req.query.c == 3){
    ...
    var sql ='SELECT "Anho" FROM "Datawarehouse"."KPI_Estudiantes_por_Docentes_TC" WHERE departamento LIKE $1 AND razonb<>0 ORDER BY "Anho"';
  }
