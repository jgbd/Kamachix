...
router.get('/', function(req, res, next) {
  if(req.query.c == 1)
    ...
    var sql ='SELECT spctt."Anho", spctt.razonanual FROM "Datawarehouse"."KPI_Students_per_Complete_Time_Teacher" spctt ORDER BY spctt."Anho"';
    ...
    var sql = 'SELECT spctt."Anho", spctt."razona", spctt."razonb", spctt.razonanual FROM "Datawarehouse"."KPI_Students_per_Complete_Time_Teacher" spctt ORDER BY spctt."Anho"';
  else if (req.query.c == 3){
    var beforedata=[req.query.anho];
    var sql = 'SELECT * FROM "Datawarehouse"."KPI_Students_per_Complete_Time_Teacher" spctt WHERE "Anho"=$1';
  }
  else if (req.query.c == 4){
    var beforedata=[req.query.anho];
    console.log(beforedata);
    var sql = 'SELECT * FROM "Datawarehouse"."KPI_Students_per_Complete_Time_Teacher" spctt WHERE "Anho"=$1 and razonb=0';
  }
